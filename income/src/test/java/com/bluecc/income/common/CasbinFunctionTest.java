...
import static com.bluecc.income.common.TestUtil.testEnforce;

public class CasbinFunctionTest {
    static String secDir(String file){
        return SystemDefs.prependHubsHome("security/"+file);
    }

    @Test
    public void testCustomFunction() {
        Enforcer e = new Enforcer(
                secDir("examples/abac_rule_custom_function_model.conf"),
                secDir("examples/abac_rule_custom_function_policy.csv"));
