...
import static com.bluecc.income.common.TestUtil.*;
...
public class RbacAPIUnitTest {
    ...
    public void testRoleAPI() {
        Enforcer e = new Enforcer(
                SystemDefs.prependHubsHome("security/examples/rbac_model.conf"),
                SystemDefs.prependHubsHome("security/examples/rbac_policy.csv"));
