...
public class KafkaSerDesLiveTest {
    ...
    private final String TOPIC = "serde-test";
    ...
    private static KafkaConsumer<String, MessageDto> createKafkaConsumer() {
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "com.bluecc.income.dummy.broker.serdes.CustomDeserializer");
    ...
    private static KafkaProducer<String, MessageDto> createKafkaProducer() {
        ...
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, "com.bluecc.income.dummy.broker.serdes.CustomSerializer");
