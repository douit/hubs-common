...
public class PartyRole implements IEventModel<PartyRoleData.Builder>, HasId, Serializable {
    ...
    public static PartyRole.PartyRoleBuilder fromPrototype(PartyRoleData data) {
