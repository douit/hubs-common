...
public class ProductStoreFacilityDelegator extends AbstractProcs implements IChainQuery<ProductStoreFacility>, IDelegator {
    ...
    public Map<String, ProductStoreFacility> chainQuery(IProc.ProcContext c, String whereClause,
                                           SelectorBindings binds,
                                           Set<String> incls) {
        Map<String, ProductStoreFacility> dataMap = Maps.newHashMap();
        Dao dao = c.getHandle().attach(Dao.class);
        Consumer<Map<String, ProductStoreFacility>> chain = tenant(dao, whereClause, binds, false);
    ...
    public void chainQueryDataList(IProc.ProcContext c,
        ...
        Map<String, ProductStoreFacility> dataMap = chainQuery(c, whereClause, binds, incls);
    ...
    @Get("/product_store_facilities/:id")
    @ProducesJson
    @ResponseConverter(GsonConverters.GsonResponseConverter.class)
    public ProductStoreFacility get(@Param String id){
    ...
    @Get("/product_store_facilities")
    @ProducesJson
    @ResponseConverter(GsonConverters.GsonResponseConverter.class)
    public Collection<ProductStoreFacility> all(){
    ...
    @Get("/product_store_facilities/count")
    @ProducesJson
    @ResponseConverter(GsonConverters.GsonResponseConverter.class)
    ...
    @Put("/product_store_facilities")
    @RequestConverter(GsonConverters.GsonRequestConverter.class)
    public String storeOrUpdate(ProductStoreFacility productStoreFacility){
        return store(productStoreFacility, false);
    }
