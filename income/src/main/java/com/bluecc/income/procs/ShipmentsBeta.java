...
public class ShipmentsBeta extends AbstractProcs{
    @Data
    @AllArgsConstructor
    @NoArgsConstructor
    static class Opts {
    ...
    public static void main(String[] args) {
        ...
        ShipmentsBeta shipmentsBeta =startup(ShipmentsBeta.class);
        shipmentsBeta.init(opts);
        shipmentsBeta.crudSample();
    }
