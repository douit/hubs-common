...
public final class TopKSelector<
     ...
     */
    public static <T extends Comparable<? super T>> com.google.common.collect.TopKSelector<T> least(int k) {
     ...
     * @throws IllegalArgumentException if {@code k < 0} or {@code k > Integer.MAX_VALUE / 2}
     */
    public static <T extends @Nullable Object> com.google.common.collect.TopKSelector<T> least(
            int k, Comparator<? super T> comparator) {
        return new com.google.common.collect.TopKSelector<T>(comparator, k);
    }
     ...
     * @throws IllegalArgumentException if {@code k < 0} or {@code k > Integer.MAX_VALUE / 2}
     */
    public static <T extends Comparable<? super T>> com.google.common.collect.TopKSelector<T> greatest(int k) {
     ...
     * @throws IllegalArgumentException if {@code k < 0} or {@code k > Integer.MAX_VALUE / 2}
     */
    public static <T extends @Nullable Object> com.google.common.collect.TopKSelector<T> greatest(
            int k, Comparator<? super T> comparator) {
        return new com.google.common.collect.TopKSelector<T>(Ordering.from(comparator).reverse(), k);
    }
