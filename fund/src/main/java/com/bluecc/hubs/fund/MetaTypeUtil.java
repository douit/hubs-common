...
public class MetaTypeUtil {
    ...
    public static final Set<String> NUMERIC_TYPES=
            Sets.newHashSet("floating-point", "double", "integer", "int32",
                    "numeric", "int64");
    public static final Set<String> FLOAT_TYPES=
            Sets.newHashSet("floating-point", "double",
                    "currency-amount", // DECIMAL(18,2)
                    "currency-precise", // DECIMAL(18,3)
                    "fixed-point" // DECIMAL(18,6)
                    );
    public static final Set<String> INT_TYPES=
            Sets.newHashSet("integer", "int32", "numeric", "int64");
