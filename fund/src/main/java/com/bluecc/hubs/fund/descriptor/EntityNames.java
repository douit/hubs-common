...
public enum EntityNames implements INameSymbol{
    ...
    CustomMethod("CustomMethod", "Custom Method","customMethodId"),
    ...
    FixedAssetDepMethod("FixedAssetDepMethod", "Fixed Asset Depreciation Method","depreciationCustomMethodId", "fixedAssetId"),
    ...
    QuoteAdjustment("QuoteAdjustment", "Quote Adjustment","quoteAdjustmentId"),
    ...
    ReturnHeader("ReturnHeader", "Return","returnId"),
    ReturnItem("ReturnItem", "Return Item","returnId", "returnItemSeqId"),
    ...
    ShoppingList("ShoppingList", "Shopping List","shoppingListId"),
    ShoppingListItem("ShoppingListItem", "Shopping List Item","shoppingListId", "shoppingListItemSeqId"),
    ...
    TechDataCalendar("TechDataCalendar", "Calendar","calendarId"),
    TechDataCalendarExcDay("TechDataCalendarExcDay", "Calendar Exception Day","calendarId", "exceptionDateStartTime"),
    TechDataCalendarWeek("TechDataCalendarWeek", "Week definition","calendarWeekId"),
    ...
    TemporalExpressionAssoc("TemporalExpressionAssoc", "Temporal Expression Association","fromTempExprId", "toTempExprId"),
    ...
    WorkEffortFixedAssetAssign("WorkEffortFixedAssetAssign", "Work Effort Fixed Asset Assignment","workEffortId", "fixedAssetId", "fromDate"),
    ...
    WorkEffortPartyAssignment("WorkEffortPartyAssignment", "Work Effort Party Assignment","workEffortId", "partyId", "roleTypeId", "fromDate"),
    WorkEffortSkillStandard("WorkEffortSkillStandard", "Work Effort Skill Standard","workEffortId", "skillTypeId"),
