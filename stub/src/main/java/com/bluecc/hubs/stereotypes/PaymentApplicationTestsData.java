...
public final class PaymentApplicationTestsData {
    public final static BillingAccountRoleData BillingAccountRole_appltest10000_DemoCustomer_BILL_TO_CUSTOMER_ = BillingAccountRoleData.newBuilder()
    ...
    public final static InvoiceFlatData Invoice_appltest10000 = InvoiceFlatData.newBuilder()
    ...
    public final static InvoiceItemFlatData InvoiceItem_appltest10000_00001 = InvoiceItemFlatData.newBuilder()
    ...
    public final static PaymentFlatData Payment_appltest10000 = PaymentFlatData.newBuilder()
        .setAmount(getCurrency("20"))
        .setCurrencyUomId("USD")
    ...
    public final static PaymentFlatData Payment_appltest10001 = PaymentFlatData.newBuilder()
        .setAmount(getCurrency("20"))
        .setCurrencyUomId("USD")
        .setEffectiveDate(getTimestamp("2006-04-25 12:56:54.292"))
        .setPartyIdFrom("Company")
    ...
    public final static PaymentFlatData Payment_appltest10002 = PaymentFlatData.newBuilder()
        .setAmount(getCurrency("20"))
        .setCurrencyUomId("USD")
        .setEffectiveDate(getTimestamp("2006-04-25 12:56:54.292"))
        .setPartyIdFrom("Company")
    ...
    public final static BillingAccountFlatData BillingAccount_appltest10000 = BillingAccountFlatData.newBuilder()
